...
class _LogPayload implements LogPayload {
  const _LogPayload({required this.level, required this.message, required this.env, this.error, this.stackTrace, required final  List<Breadcrumb> breadcrumbs, this.service = 'app'}): _breadcrumbs = breadcrumbs;
